#The following code is the A* algorithm. Also Known as the Path finding algorithm.
#Goal of the algorithm is to find the shortest path from point A to point B
#Main formula to get estimated distance from start Node to end Node --> f(n) = 6n + h(n)
...
def h(p1, p2): #p1 is point 1 p2 is point 2
    x1, y1 = p1
    x2, y2 = p2
...
def algorithm(draw, grid, start, end):
	count = 0
	open_set = PriorityQueue()#Helps finder smallest point and uses Heap algorithm
